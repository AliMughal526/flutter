  ...
  Future<void> fetchAndStoreData() async {
    ...
    if (response.statusCode == 200) {
      try {
        ...
        // In case response is wrapped inside a key
        List<dynamic> data = responseBody is List ? responseBody : responseBody['data'];
        ...
        print('✅ Data successfully loaded and stored in database.');
      } catch (e) {
        print('❌ Error decoding or inserting data: $e');
      }
    } else {
